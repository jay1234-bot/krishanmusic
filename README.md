<h1 align="center">🎵 MBV Music Bot 🎵</h1>
...
1. **Join our Support Group**: Type `#script` in our [support group](https://t.me/MBV_NETWORK) to get the necessary script.
...
## 🚀 Deploy on Heroku 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/FantasticSukhi/MBVMusic)
...
5. **Clone the Repository**
   ```bash
   git clone https://github.com/FantasticSukhi/MBVMusic && cd MBVMusic
   ```
...
For a full list of commands, use `/help` in [telegram](https://t.me/MBV_NETWORK).

---

### 🔄 Updates & Support

Stay updated with the latest features and improvements to MBV Music Bot:

<p align="center">
  <a href="https://t.me/MBV_NETWORK">
    <img src="https://img.shields.io/badge/Join-Support%20Group-blue?style=for-the-badge&logo=telegram">
  </a>
  <a href="https://t.me/+kf5prJAMarhkOWJl">
...
We welcome contributions to the MBV Music Bot project. If you'd like to contribute, please follow these steps:
